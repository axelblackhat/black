...
function banner(){
    echo -e "\n${turquoiseColour}    _   _                         _     _            _   "
    sleep 0.05
    echo -e "   / \ | |_ __   ___  _ __   ___| |__ (_)_ __   ___| |_ "
    sleep 0.05
    echo -e "  / _ \| | '_ \ / _ \| '_ \ / __| '_ \| | '_ \ / _ \ __|"
    sleep 0.05
    echo -e " / ___ \ | | | | (_) | | | | (__| | | | | | | |  __/ |_ "
    sleep 0.05
    echo -e "/_/   \_\_|_| |_|\___/|_| |_|\___|_| |_|_|_| |_|\___|\__|"
    sleep 0.05
    echo -e "   ____  _            _       _   _           _   "
    sleep 0.05
    echo -e "  | __ )| | __ _  ___| | __  | | | | __ _ ___| |_ "
    sleep 0.05
