...
function banner(){
  ...
  sleep 0.05; echo "  ___                   _              "
  sleep 0.05; echo " / _ \                 | |             "
  sleep 0.05; echo "/ /_\ \_ __  _   _  ___| | ___         "
  sleep 0.05; echo "|  _  | '_ \| | | |/ _ \ |/ _ \        "
  sleep 0.05; echo "| | | | | | | |_| |  __/ | (_) |       "
  sleep 0.05; echo "\_| |_/_| |_|\__, |\___|_|\___/        "
  sleep 0.05; echo "              __/ |                   "
  sleep 0.05; echo "             |___/                    "
  sleep 0.05; echo "______            _    _   _       _  "
  sleep 0.05; echo "| ___ \          | |  | | | |     | | "
  sleep 0.05; echo "| |_/ / __ _  ___| | _| |_| | __ _| |_"
  sleep 0.05; echo "| ___ \/ _\` |/ __| |/ /  _  |/ _\` | __|"
  sleep 0.05; echo "| |_/ / (_| | (__|   <| | | | (_| | |_"
  sleep 0.05; echo "\____/ \__,_|\___|_|\_\_| |_/\__,_|\__|"
  sleep 0.05; echo -e             "${endColour}${yellowColour}(╯°□°）╯${endColour}"
}
...
# Instalar neofetch desde GitHub
